...
const buttonVariants = cva(
  'rounded-md inline-flex items-center justify-center font-semibold transition-colors duration-200 disabled:disabled-classes cursor-pointer pointer-events-auto',
  {
    variants: {
